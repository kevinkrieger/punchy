...
// second though)
/*
const uint8_t dmpMemory0[MPU6050_DMP_CODE_SIZE0] = {
    // bank 0, 256 bytes
...
const uint8_t dmpMemory1[MPU6050_DMP_CODE_SIZE1] = {
// bank 1, 256 bytes
...
const uint8_t dmpMemory2[MPU6050_DMP_CODE_SIZE2] = {
     // bank 2, 256 bytes
...
const uint8_t dmpMemory3[MPU6050_DMP_CODE_SIZE3] = {
    // bank 3, 256 bytes
...
const uint8_t dmpMemory4[MPU6050_DMP_CODE_SIZE4] = {
    // bank 4, 256 bytes
...
const uint8_t dmpMemory5[MPU6050_DMP_CODE_SIZE5] = {
    // bank 5, 256 bytes
...
const uint8_t dmpMemory6[MPU6050_DMP_CODE_SIZE6] = {
    // bank 6, 256 bytes
...
const uint8_t dmpMemory7[MPU6050_DMP_CODE_SIZE7] = {
...
//#endif
  ...
  /*  for(i = 0; i< 2000; i++){
   ...
   /* if ( mpu6050_writeProgMemoryBlock(dmpMemory0, MPU6050_DMP_CODE_SIZE0,0,0,true) &&
        mpu6050_writeProgMemoryBlock(dmpMemory1, MPU6050_DMP_CODE_SIZE1,0,0,true) &&
        mpu6050_writeProgMemoryBlock(dmpMemory2, MPU6050_DMP_CODE_SIZE2,0,0,true) &&
        mpu6050_writeProgMemoryBlock(dmpMemory3, MPU6050_DMP_CODE_SIZE3,0,0,true) &&
        mpu6050_writeProgMemoryBlock(dmpMemory4, MPU6050_DMP_CODE_SIZE4,0,0,true) &&
        mpu6050_writeProgMemoryBlock(dmpMemory5, MPU6050_DMP_CODE_SIZE5,0,0,true) &&
        mpu6050_writeProgMemoryBlock(dmpMemory6, MPU6050_DMP_CODE_SIZE6,0,0,true) &&
        mpu6050_writeProgMemoryBlock(dmpMemory7, MPU6050_DMP_CODE_SIZE7,0,0,true)) {*/
 #ifdef MPU6050_DEBUG
