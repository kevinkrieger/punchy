...
uint8_t mpu6050_getOTPBankValid() {
   // i2c_readBit(MPU6050_RA_XG_OFFS_TC, MPU6050_TC_OTP_BNK_VLD_BIT, buffer);
...
uint8_t mpu6050_readMemoryByte() {
    //i2c_readByte(MPU6050_RA_MEM_R_W, buffer);
    i2c_read_reg(MPU6050_RA_MEM_R_W);
    return i2c_rx_buffer[0];
}

int8_t mpu6050_getXGyroOffset() {
    //i2c_readBits(MPU6050_RA_YG_OFFS_TC, MPU6050_TC_OFFSET_BIT, MPU6050_TC_OFFSET_LENGTH, buffer);
